...
const consulta2 = criarConsulta(1, medico1, paciente1, new Date(), 200)
const consulta3 = criarConsulta(2, medico2, paciente2, new Date(), 150)
const consulta4 = criarConsulta(3, medico3, paciente3, new Date(), 3000)

consultas.push(consulta3, consulta2, consulta4)
